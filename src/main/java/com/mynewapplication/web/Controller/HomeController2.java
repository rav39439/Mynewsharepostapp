...
public class HomeController2 {
	...
	public String Myhome(Model model, Principal principal) {
		...
		System.out.println("thasssssssssssssssssssssssssssssssssssssssssssssssssssssssssl");
	...
	// public String sendmemail(@ModelAttribute("emaildata") Emailrequest
	// emailrequest,@RequestParam("id") int id ,HttpSession session)
	// {
	// int otp = random.nextInt(99999);
	//
	...
	//
	// public String verifyemail(@RequestParam("to") int userotp,Model m,HttpSession
	// session) {
	//
	// int myOtp=(int)session.getAttribute("myotp");
	//
	...
	//
	@PostMapping("/saveuser")
	public ResponseEntity<InfoUser> handlepost(@RequestParam("name") String username,
			@RequestParam("degree") String Degree, @RequestParam("myfile") String myfile) {
